CLASS zcl_abappm_url_params DEFINITION PUBLIC FINAL CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS parse
      IMPORTING
        !query        TYPE string
      RETURNING
        VALUE(result) TYPE REF TO zcl_abappm_url_params.
...
CLASS zcl_abappm_url_params IMPLEMENTATION.
