...
* https://github.com/npm/node-semver/blob/main/tap-snapshots/test/bin/semver.js.test.cjs
  PRIVATE SECTION.
    ...
    METHODS:
      ...
      help FOR TESTING RAISING /apmg/cx_apm_error,
      inc FOR TESTING RAISING /apmg/cx_apm_error,
      sorting_and_filtering FOR TESTING RAISING /apmg/cx_apm_error,
      coercing FOR TESTING RAISING /apmg/cx_apm_error,
      args_with_equals FOR TESTING RAISING /apmg/cx_apm_error.

ENDCLASS.

CLASS /apmg/cl_apm_semver_cli DEFINITION LOCAL FRIENDS ltcl_semver_cli.
...
CLASS ltcl_semver_cli IMPLEMENTATION.
  ...
  METHOD test.
    ...
    TRY.
        DATA(act_out) = /apmg/cl_apm_semver_cli=>main( args ).
  ...
  METHOD help.
    ...
    test(
      args    = '-h'
      out_tab = /apmg/cl_apm_semver_cli=>_help( ) ).
