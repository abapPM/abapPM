CLASS ltcl_semver_ranges DEFINITION FOR TESTING RISK LEVEL HARMLESS
  ...
  PRIVATE SECTION.
    ...
    METHODS:
      ...
      gtr FOR TESTING RAISING /apmg/cx_apm_error,
      intersects FOR TESTING RAISING /apmg/cx_apm_error,
      ltr FOR TESTING RAISING /apmg/cx_apm_error,
      max_satisfying FOR TESTING RAISING /apmg/cx_apm_error,
      min_satisfying FOR TESTING RAISING /apmg/cx_apm_error,
      min_version FOR TESTING RAISING /apmg/cx_apm_error,
      outside FOR TESTING RAISING /apmg/cx_apm_error,
      simplify FOR TESTING RAISING /apmg/cx_apm_error,
      subset FOR TESTING RAISING /apmg/cx_apm_error,
      to_comparators FOR TESTING RAISING /apmg/cx_apm_error,
      valid_range FOR TESTING RAISING /apmg/cx_apm_error.
...
CLASS ltcl_semver_ranges IMPLEMENTATION.
  ...
  METHOD gtr.
    ...
    LOOP AT /apmg/cl_apm_semver_fixtures=>version_gt_range( ) INTO DATA(version_gt_range).
      DATA(msg) = |{ version_gt_range-range } { version_gt_range-version } { _bool( version_gt_range-loose ) }|.
      DATA(act) = /apmg/cl_apm_semver_ranges=>gtr(
    ...
    LOOP AT /apmg/cl_apm_semver_fixtures=>version_not_gt_range( ) INTO DATA(version_not_gt_range).
      ...
      act = /apmg/cl_apm_semver_ranges=>gtr(
  ...
  METHOD intersects.
    ...
    LOOP AT /apmg/cl_apm_semver_fixtures=>comparator_intersection( ) INTO DATA(comparator_intersection).
      DATA(msg) = |{ comparator_intersection-c0 } { comparator_intersection-c1 } { _bool( comparator_intersection-res ) }|.

      DATA(comp0) = /apmg/cl_apm_semver_comparator=>create( comparator_intersection-c0 ).
      DATA(comp1) = /apmg/cl_apm_semver_comparator=>create( comparator_intersection-c1 ).

      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = comp0 r2 = comp1 )
        exp = comparator_intersection-res
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = comp1 r2 = comp0 )
        exp = comparator_intersection-res
        msg = msg ).

      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = comp0 r2 = comp1 loose = abap_true )
        exp = comparator_intersection-res
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = comp1 r2 = comp0 loose = abap_true )
        exp = comparator_intersection-res
        msg = msg ).

      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = comparator_intersection-c0 r2 = comparator_intersection-c1 )
        exp = comparator_intersection-res
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = comparator_intersection-c1 r2 = comparator_intersection-c0 )
        exp = comparator_intersection-res
        msg = msg ).

      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = comparator_intersection-c0 r2 = comparator_intersection-c1 loose = abap_true )
        exp = comparator_intersection-res
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = comparator_intersection-c1 r2 = comparator_intersection-c0 loose = abap_true )
        exp = comparator_intersection-res
        msg = msg ).
    ENDLOOP.

    " Ranges intersect
    LOOP AT /apmg/cl_apm_semver_fixtures=>range_intersection( ) INTO DATA(range_intersection).
      msg = |{ range_intersection-r0 } { range_intersection-r1 } { _bool( range_intersection-res ) }|.

      DATA(range0) = /apmg/cl_apm_semver_range=>create( range_intersection-r0 ).
      DATA(range1) = /apmg/cl_apm_semver_range=>create( range_intersection-r1 ).

      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = range0 r2 = range1 )
        exp = range_intersection-res
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = range1 r2 = range0 )
        exp = range_intersection-res
        msg = msg ).

      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = range0 r2 = range1 loose = abap_true )
        exp = range_intersection-res
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = range1 r2 = range0 loose = abap_true )
        exp = range_intersection-res
        msg = msg ).

      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = range_intersection-r0 r2 = range_intersection-r1 )
        exp = range_intersection-res
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = range_intersection-r1 r2 = range_intersection-r0 )
        exp = range_intersection-res
        msg = msg ).

      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = range_intersection-r0 r2 = range_intersection-r1 loose = abap_true )
        exp = range_intersection-res
        msg = msg ).
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>intersects( r1 = range_intersection-r1 r2 = range_intersection-r0 loose = abap_true )
        exp = range_intersection-res
        msg = msg ).
    ENDLOOP.
  ...
  METHOD ltr.
    ...
    LOOP AT /apmg/cl_apm_semver_fixtures=>version_lt_range( ) INTO DATA(version_lt_range).
      DATA(msg) = |{ version_lt_range-range } { version_lt_range-version } { _bool( version_lt_range-loose ) }|.
      DATA(act) = /apmg/cl_apm_semver_ranges=>ltr(
    ...
    LOOP AT /apmg/cl_apm_semver_fixtures=>version_not_lt_range( ) INTO DATA(version_not_lt_range).
      ...
      act = /apmg/cl_apm_semver_ranges=>ltr(
  ...
  METHOD max_satisfying.
    ...
    LOOP AT tests INTO DATA(test).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>max_satisfying( versions = versions range = test-range loose = test-loose )
        exp = test-res
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_apm_semver_ranges=>max_satisfying( versions = versions range = range )
      exp = ''
      msg = |{ range }| ).
  ...
  METHOD min_satisfying.
    ...
    LOOP AT tests INTO DATA(test).
      ...
      cl_abap_unit_assert=>assert_equals(
        act = /apmg/cl_apm_semver_ranges=>min_satisfying( versions = versions range = test-range loose = test-loose )
        exp = test-res
        msg = |{ test-versions } { test-range } { test-res }| ).
    ENDLOOP.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_apm_semver_ranges=>min_satisfying( versions = versions range = range )
      exp = ''
      msg = |{ range }| ).
  ...
  METHOD min_version.
    ...
    LOOP AT tests INTO DATA(test).
      DATA(act) = /apmg/cl_apm_semver_ranges=>min_version( range = test-range loose = test-loose ).
  ...
  METHOD outside.
    ...
    LOOP AT /apmg/cl_apm_semver_fixtures=>version_gt_range( ) INTO DATA(version_gt_range).
      ...
      DATA(act) = /apmg/cl_apm_semver_ranges=>outside(
        version = version_gt_range-version
        range   = version_gt_range-range
        hilo    = '>'
        loose   = version_gt_range-loose ).
    ...
    LOOP AT /apmg/cl_apm_semver_fixtures=>version_lt_range( ) INTO DATA(version_lt_range).
      ...
      act = /apmg/cl_apm_semver_ranges=>outside(
        version = version_lt_range-version
        range   = version_lt_range-range
        hilo    = '<'
        loose   = version_lt_range-loose ).
  ...
  METHOD simplify.
    ...
    cl_abap_unit_assert=>assert_equals(
      act = /apmg/cl_apm_semver_ranges=>simplify(
              versions = versions
              range    = '1.x' )
      exp = '1.x' ).
    ...
    DATA(range) = /apmg/cl_apm_semver_range=>create( '1.0.0 || 1.0.1 || 1.0.2 || 1.0.3 || 1.0.4' ).
  ...
  METHOD to_comparators.
    ...
    LOOP AT tests INTO DATA(test).
      DATA(comparators) = /apmg/cl_apm_semver_ranges=>to_comparators( test-range ).
  ...
  METHOD valid_range.
    ...
    LOOP AT /apmg/cl_apm_semver_fixtures=>range_parse( ) INTO DATA(range_parse).
      DATA(msg) = |{ range_parse-range } { range_parse-res } { _bool( range_parse-loose ) } { _bool( range_parse-incpre ) }|.
      DATA(act) = /apmg/cl_apm_semver_ranges=>valid_range(
