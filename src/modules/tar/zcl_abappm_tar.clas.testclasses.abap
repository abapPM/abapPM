CLASS ltcl_tar_tests DEFINITION FOR TESTING RISK LEVEL HARMLESS DURATION SHORT FINAL.
  ...
  PRIVATE SECTION.
    DATA mo_cut TYPE REF TO zcl_abappm_tar.

    METHODS:
      setup,
      null FOR TESTING,
      filename FOR TESTING RAISING zcx_abappm_tar,
      checksum FOR TESTING RAISING zcx_abappm_tar,
      octal FOR TESTING,
      pad FOR TESTING,
      unixtime FOR TESTING RAISING zcx_abappm_tar,
      xstring FOR TESTING RAISING zcx_abappm_tar.
...
CLASS ltcl_tar_tests IMPLEMENTATION.
  ...
  METHOD filename.
    ...
    DATA:
      ...
      lv_prefix   TYPE zcl_abappm_tar=>ty_header-prefix,
      lv_name     TYPE zcl_abappm_tar=>ty_header-name.
