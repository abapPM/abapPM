  ...
  METHOD from_xstring.
    ...
    TRY.
      ...
      CATCH cx_sy_codepage_converter_init
        ...
        RAISE EXCEPTION TYPE zcx_abappm_error_text EXPORTING text = 'Error converting from xstring'.
    ENDTRY.
  ...
  METHOD to_xstring.
    ...
    TRY.
      ...
      CATCH cx_sy_codepage_converter_init
            cx_sy_conversion_codepage
            cx_parameter_invalid_type.
        RAISE EXCEPTION TYPE zcx_abappm_error_text EXPORTING text = 'Error converting to xstring'.
    ENDTRY.
...
CLASS lcl_7zip IMPLEMENTATION.
  ...
  METHOD decode_longlink.
    ...
    DATA(header) = CONV zcl_abappm_tar=>ty_header( lcl_tar_helpers=>from_xstring( block_1 ) ).
