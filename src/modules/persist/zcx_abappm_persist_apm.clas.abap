CLASS zcx_abappm_persist_apm DEFINITION
  PUBLIC
  INHERITING FROM cx_static_check
  CREATE PUBLIC.

************************************************************************
* apm Persistence Error
*
...
************************************************************************
  PUBLIC SECTION.
    ...
    "! @raising zcx_abappm_persist_apm | Exception
    CLASS-METHODS raise
      IMPORTING
        !iv_text     TYPE clike
...
CLASS zcx_abappm_persist_apm IMPLEMENTATION.
  ...
  METHOD raise_t100.
    ...
    RAISE EXCEPTION TYPE zcx_abappm_persist_apm
      EXPORTING
        textid   = ls_t100_key
        msgv1    = iv_msgv1
        msgv2    = iv_msgv2
