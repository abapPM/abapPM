CLASS /apmg/cl_apm_ajson_ref_initial DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS create_path_refs_init
      IMPORTING
        !it_data_refs       TYPE /apmg/if_apm_ajson_ref_initial=>tty_data_refs
      RETURNING
        VALUE(ri_refs_init) TYPE REF TO /apmg/if_apm_ajson_ref_initial
      RAISING
