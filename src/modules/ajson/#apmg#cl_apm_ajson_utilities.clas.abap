  ...
  PUBLIC SECTION.
    ...
    CLASS-METHODS iterate_array
      IMPORTING
        ...
        iv_path            TYPE string
      RETURNING
        VALUE(ri_iterator) TYPE REF TO /apmg/if_apm_ajson_iterator
      RAISING
        /apmg/cx_apm_ajson_error.
...
CLASS /apmg/cl_apm_ajson_utilities IMPLEMENTATION.
    ...
    DO.
      ...
      IF iv_keep_empty_arrays = abap_false.
        LOOP AT io_json->mt_json_tree INTO ls_json_tree
          WHERE type = /apmg/if_apm_ajson_types=>node_type-array AND children = 0. "#EC CI_SORTSEQ
      ...
      LOOP AT io_json->mt_json_tree INTO ls_json_tree
        WHERE type = /apmg/if_apm_ajson_types=>node_type-object AND children = 0. "#EC CI_SORTSEQ
  ...
  METHOD iterate_array.
    ...
    CREATE OBJECT ri_iterator TYPE lcl_node_iterator
      EXPORTING
        iv_node_type = /apmg/if_apm_ajson_types=>node_type-array
        ii_json      = ii_json
        iv_path      = iv_path.
  ...
  METHOD iterate_object.
    ...
    CREATE OBJECT ri_iterator TYPE lcl_node_iterator
      EXPORTING
        iv_node_type = /apmg/if_apm_ajson_types=>node_type-object
        ii_json      = ii_json
        iv_path      = iv_path.
