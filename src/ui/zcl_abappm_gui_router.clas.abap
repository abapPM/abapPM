...
************************************************************************
  ...
  PRIVATE SECTION.
    ...
    METHODS general_page_routing
      ...
      RETURNING
        VALUE(result) TYPE zif_abapgit_gui_event_handler=>ty_handling_result
      RAISING
...
*        result-state = zcl_abapgit_gui=>c_event_state-new_page
  ...
  METHOD jump_display_transport.
    ...
    IF is_adt_jump_enabled = abap_true.
      TRY.
          ...
          zcl_abapgit_ui_factory=>get_frontend_services( )->execute( iv_document = adt_link ).
  ...
  METHOD jump_object.
    ...
    TRY.
        ...
        ELSEIF line_number IS INITIAL OR sub_item IS INITIAL.
  ...
  METHOD zif_abapgit_gui_event_handler~on_event.
    ...
    DATA result TYPE zif_abapgit_gui_event_handler=>ty_handling_result.
    ...
    IF result-state IS INITIAL.
      result-state = zcl_abapgit_gui=>c_event_state-not_handled.
    ENDIF.
