...
* adapted: gui_component and settings
  PUBLIC SECTION.
    ...
    INTERFACES zif_abappm_gui_hotkey_ctl.
    INTERFACES zif_abappm_gui_renderable.
  ...
  PRIVATE SECTION.
    ...
    DATA:
      hotkeys           TYPE zif_abappm_gui_hotkeys=>ty_hotkeys_with_descr,
...
CLASS zcl_abappm_gui_hotkey_ctl IMPLEMENTATION.
  ...
  METHOD zif_abappm_gui_hotkey_ctl~get_registered_hotkeys.
    rt_registered_hotkeys = hotkeys.
  ENDMETHOD.


  METHOD zif_abappm_gui_hotkey_ctl~register_hotkeys.
  ...
  METHOD zif_abappm_gui_hotkey_ctl~reset.
    CLEAR hotkeys.
  ENDMETHOD.


  METHOD zif_abappm_gui_hotkey_ctl~set_visible.
  ...
  METHOD zif_abappm_gui_renderable~render.
    ...
    DATA(result) = zcl_abappm_html=>create( ).

    DATA(registered_hotkeys) = zif_abappm_gui_hotkey_ctl~get_registered_hotkeys( ).
    ...
    result = zcl_abappm_gui_chunk_lib=>render_infopanel(
      iv_div_id     = 'hotkeys'
      iv_title      = 'Hotkeys'
      iv_hint       = hint
