...
CLASS ltcl_gui_utils IMPLEMENTATION.
  ...
  METHOD is_renderable.
    ...
    cl_abap_unit_assert=>assert_equals( exp = abap_true
                                        act = /apmg/cl_apm_gui_utils=>is_renderable( lo_renderable ) ).
    cl_abap_unit_assert=>assert_equals( exp = abap_false
                                        act = /apmg/cl_apm_gui_utils=>is_renderable( lo_handler ) ).
  ...
  METHOD is_event_handler.
    ...
    cl_abap_unit_assert=>assert_equals( exp = abap_false
                                        act = /apmg/cl_apm_gui_utils=>is_event_handler( lo_renderable ) ).
    cl_abap_unit_assert=>assert_equals( exp = abap_true
                                        act = /apmg/cl_apm_gui_utils=>is_event_handler( lo_handler ) ).
