...
CLASS ltcl_part_collections IMPLEMENTATION.
  ...
  METHOD test.
    ...
    DATA lo_html1 TYPE REF TO /apmg/cl_apm_html.
    DATA lo_html2 TYPE REF TO /apmg/cl_apm_html.
    DATA lo_html3 TYPE REF TO /apmg/cl_apm_html.
    DATA lo_html_tmp TYPE REF TO /apmg/if_apm_html.
    DATA lo_parts TYPE REF TO /apmg/cl_apm_html_parts.
    DATA lt_col_exp TYPE string_table.
    DATA lt_parts_act TYPE /apmg/if_apm_html=>ty_table_of.
