CLASS zcl_abappm_html_parts DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    METHODS add_part
      IMPORTING
        ...
        !ii_part       TYPE REF TO zif_abappm_html.

    METHODS get_parts
      IMPORTING
        !iv_collection  TYPE string
      RETURNING
        VALUE(rt_parts) TYPE zif_abappm_html=>ty_table_of.
  ...
  PRIVATE SECTION.
    ...
    TYPES:
      BEGIN OF ty_named_collection,
        name TYPE string,
        pile TYPE zif_abappm_html=>ty_table_of,
...
CLASS zcl_abappm_html_parts IMPLEMENTATION.
