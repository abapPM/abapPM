INTERFACE zif_abappm_gui_services PUBLIC.
  ...
  METHODS register_event_handler
    IMPORTING
      !ii_event_handler TYPE REF TO zif_abappm_gui_event_handler.
  ...
  METHODS get_hotkeys_ctl
    RETURNING
      VALUE(ri_hotkey_ctl) TYPE REF TO zif_abappm_gui_hotkey_ctl.

  METHODS get_html_parts
    RETURNING
      VALUE(ro_parts) TYPE REF TO zcl_abappm_html_parts.
