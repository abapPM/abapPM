INTERFACE zif_abappm_html PUBLIC.
  ...
  TYPES:
    ...
    ty_table_of   TYPE STANDARD TABLE OF REF TO zif_abappm_html WITH DEFAULT KEY.
  ...
  METHODS set_title
    ...
    RETURNING
      VALUE(ri_self) TYPE REF TO zif_abappm_html.
  ...
  METHODS wrap
    IMPORTING
      ...
      !ii_content            TYPE REF TO zif_abappm_html OPTIONAL
      !iv_id                 TYPE string OPTIONAL
      !iv_class              TYPE string OPTIONAL
      !iv_hint               TYPE string OPTIONAL
