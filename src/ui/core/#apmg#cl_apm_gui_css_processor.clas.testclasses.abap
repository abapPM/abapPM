  ...
  PROTECTED SECTION.
    METHODS:
      add_file IMPORTING iv_url     TYPE string
               ...
               RAISING   /apmg/cx_apm_error.
    DATA:
      mi_asset_manager TYPE REF TO /apmg/if_apm_gui_asset_manager,
      mo_cut           TYPE REF TO /apmg/cl_apm_gui_css_processor.
  PRIVATE SECTION.
    METHODS:
      setup.
ENDCLASS.
...
CLASS ltcl_test_base IMPLEMENTATION.
  METHOD setup.
    mi_asset_manager = /apmg/cl_apm_gui_asset_manager=>create( ).
...
CLASS ltcl_single_file DEFINITION FOR TESTING RISK LEVEL HARMLESS DURATION SHORT INHERITING FROM ltcl_test_base.
  PUBLIC SECTION.
    METHODS:
      test_file_exists FOR TESTING RAISING /apmg/cx_apm_error,
      test_file_does_not_exist FOR TESTING,
      test_empty_file FOR TESTING RAISING /apmg/cx_apm_error,
      test_no_variables FOR TESTING RAISING /apmg/cx_apm_error,
      test_simple_variables FOR TESTING RAISING /apmg/cx_apm_error,
      test_complex_variables FOR TESTING RAISING /apmg/cx_apm_error,
      test_overwrite FOR TESTING RAISING /apmg/cx_apm_error.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
...
CLASS ltcl_multiple_files DEFINITION FOR TESTING RISK LEVEL HARMLESS DURATION SHORT INHERITING FROM ltcl_test_base.
  PUBLIC SECTION.
    METHODS:
      test_simple FOR TESTING RAISING /apmg/cx_apm_error,
      test_overwrite FOR TESTING RAISING /apmg/cx_apm_error.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
