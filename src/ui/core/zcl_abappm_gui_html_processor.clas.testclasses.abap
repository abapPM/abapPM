...
CLASS zcl_abappm_gui_html_processor DEFINITION LOCAL FRIENDS ltcl_html_processor_test.
...
CLASS ltcl_html_processor_test DEFINITION
  ...
  PRIVATE SECTION.
    ...
    DATA mo_cut TYPE REF TO zcl_abappm_gui_html_processor.
    ...
    METHODS setup RAISING zcx_abappm_error.
    METHODS process_typical FOR TESTING RAISING zcx_abappm_error.
    METHODS process_with_preserve FOR TESTING RAISING zcx_abappm_error.
    METHODS process_no_css FOR TESTING RAISING zcx_abappm_error.
    METHODS process_fails FOR TESTING RAISING zcx_abappm_error.
    METHODS find_head_closing_tag FOR TESTING RAISING zcx_abappm_error.
ENDCLASS.
...
CLASS ltcl_html_processor_test IMPLEMENTATION.
  ...
  METHOD process_typical.
    ...
    lv_act = mo_cut->zif_abappm_gui_html_processor~process(
      iv_html = mv_source
  ...
  METHOD process_fails.
    ...
    TRY.
        ...
        mo_cut->zif_abappm_gui_html_processor~process(
