...
************************************************************************
  CONSTANTS:
    BEGIN OF c_action,
      ...
      apm_login            TYPE string VALUE 'apm_login',
      apm_logout           TYPE string VALUE 'apm_logout',
      ...
      go_welcome           TYPE string VALUE 'go_welcome',
      ...
      playground           TYPE string VALUE 'playground',
