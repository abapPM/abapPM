CLASS zcl_abappm_ui_factory DEFINITION
  PUBLIC
  CREATE PRIVATE
...
CLASS zcl_abappm_ui_factory IMPLEMENTATION.
  ...
  METHOD get_frontend_services.
    ...
    IF gi_fe_services IS INITIAL.
      " apm todo: CREATE OBJECT gi_fe_services TYPE zcl_abapgit_frontend_services
    ENDIF.
  ...
  METHOD get_popups.
    ...
    IF gi_popups IS INITIAL.
      " apm todo: CREATE OBJECT gi_popups TYPE zcl_abapgit_popups
    ENDIF.
