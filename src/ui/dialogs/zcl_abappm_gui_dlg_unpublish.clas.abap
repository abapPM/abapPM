CLASS zcl_abappm_gui_dlg_unpublish DEFINITION
  PUBLIC
...
CLASS zcl_abappm_gui_dlg_unpublish IMPLEMENTATION.
  ...
  METHOD create.
    ...
    DATA(component) = NEW zcl_abappm_gui_dlg_unpublish( package ).
      ...
      WHEN c_action-unpublish_package.
        ...
        IF validation_log->is_empty( ) = abap_true.
          ...
          IF confirm_popup( params ) = abap_true.
            zcl_abappm_command_unpublish=>run(
              registry = registry
              name     = params-name
