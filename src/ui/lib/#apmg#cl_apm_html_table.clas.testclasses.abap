CLASS ltcl_test_simple_table DEFINITION FINAL
  ...
  DURATION SHORT.
  PUBLIC SECTION.
    INTERFACES /apmg/if_apm_html_table.
    ...
    METHODS simple_render FOR TESTING RAISING /apmg/cx_apm_error.
    METHODS with_cids FOR TESTING RAISING /apmg/cx_apm_error.
    METHODS with_sort FOR TESTING RAISING /apmg/cx_apm_error.
    METHODS with_groups FOR TESTING RAISING /apmg/cx_apm_error.
...
CLASS ltcl_test_simple_table IMPLEMENTATION.
  METHOD /apmg/if_apm_html_table~get_row_attrs.
    ...
    ELSEIF iv_table_id = 'with-cids'.
      rs_attrs-data = /apmg/cl_apm_html=>parse_data_attr( |attr={ iv_row_index }| ).
    ENDIF.
  ENDMETHOD.
  ...
  METHOD /apmg/if_apm_html_table~render_cell.
    IF iv_table_id = 'simple'.
      ...
      IF iv_column_id = 'colX'.
        IF iv_row_index = 2.
          rs_render-html = /apmg/cl_apm_html=>create( )->add( 'XHTML' ).
        ELSE.
          rs_render-content = 'X'.
        ENDIF.
      ELSE.
  ...
  METHOD simple_render.
    ...
    DATA lo_tab TYPE REF TO /apmg/cl_apm_html_table.
    DATA lv_html_act TYPE string.
    DATA li_html_exp TYPE REF TO /apmg/if_apm_html.

    lo_tab = /apmg/cl_apm_html_table=>create( me
      )->define_column(
        iv_column_id = 'col1'
    ...
    CREATE OBJECT li_html_exp TYPE /apmg/cl_apm_html.
  ...
  METHOD with_sort.
    ...
    DATA lv_html_act TYPE string.
    DATA li_html_exp TYPE REF TO /apmg/if_apm_html.
    DATA ls_sort TYPE /apmg/if_apm_html_table=>ty_sorting_state.
