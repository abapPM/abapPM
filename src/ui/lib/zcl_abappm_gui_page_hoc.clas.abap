...
* adapted: gui_page
  PUBLIC SECTION.
    ...
    CLASS-METHODS create
      IMPORTING
        !child_component     TYPE REF TO zif_abappm_gui_renderable
        !page_title          TYPE string OPTIONAL
        !page_layout         TYPE string DEFAULT zcl_abappm_gui_page=>c_page_layout-centered
        !page_menu           TYPE REF TO zcl_abappm_html_toolbar OPTIONAL
        !page_menu_provider  TYPE REF TO zif_abappm_gui_menu_provider OPTIONAL
        !page_title_provider TYPE REF TO zif_abappm_gui_page_title OPTIONAL
    ...
    METHODS constructor
      IMPORTING
        !child_component TYPE REF TO zif_abappm_gui_renderable
        !page_controller TYPE zcl_abappm_gui_page=>ty_control
      RAISING
        zcx_abappm_error.
  ...
  PRIVATE SECTION.
    ...
    DATA child_component TYPE REF TO zif_abappm_gui_renderable.
    ...
    METHODS detect_menu_provider
      RETURNING
        VALUE(result) TYPE REF TO zif_abappm_gui_menu_provider.

    METHODS detect_title_provider
      RETURNING
        VALUE(result) TYPE REF TO zif_abappm_gui_page_title.
...
CLASS zcl_abappm_gui_page_hoc IMPLEMENTATION.
  ...
  METHOD create.
    ...
    DATA(page_control) = VALUE zcl_abappm_gui_page=>ty_control(
  ...
  METHOD detect_modal.
    ...
    DATA modal TYPE REF TO zif_abappm_gui_modal.
