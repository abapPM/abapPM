...
************************************************************************
  PUBLIC SECTION.
    ...
    CLASS-METHODS experimental
      IMPORTING
        !menu TYPE REF TO zcl_abappm_html_toolbar.
...
CLASS zcl_abappm_gui_menus IMPLEMENTATION.
  ...
  METHOD advanced.
    ...
    result = zcl_abappm_html_toolbar=>create( 'apm-toolbar-advanced' ).
    ...
    IF zcl_abappm_gui_factory=>get_frontend_services( )->is_sapgui_for_windows( ) = abap_true.
      result->add(
  ...
  METHOD back.
    ...
    result = zcl_abappm_html_toolbar=>create( 'apm-toolbar-back' ).
...
*      iv_act = zif_abappm_gui_router=>c_action-go_tutorial
  ...
  METHOD settings.
    ...
    result = zcl_abappm_html_toolbar=>create( 'apm-toolbar-settings' ).
