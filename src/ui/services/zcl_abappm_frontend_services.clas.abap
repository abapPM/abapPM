CLASS zcl_abappm_frontend_services DEFINITION
  PUBLIC
  CREATE PRIVATE
  ...
  PUBLIC SECTION.
    ...
    INTERFACES zif_abappm_frontend_services.
...
CLASS zcl_abappm_frontend_services IMPLEMENTATION.
  ...
  METHOD zif_abappm_frontend_services~clipboard_export.
  ...
  METHOD zif_abappm_frontend_services~directory_browse.
  ...
  METHOD zif_abappm_frontend_services~directory_create.
  ...
  METHOD zif_abappm_frontend_services~directory_exist.
  ...
  METHOD zif_abappm_frontend_services~execute.
  ...
  METHOD zif_abappm_frontend_services~file_download.
  ...
  METHOD zif_abappm_frontend_services~file_upload.
  ...
  METHOD zif_abappm_frontend_services~get_file_separator.
  ...
  METHOD zif_abappm_frontend_services~get_gui_version.
  ...
  METHOD zif_abappm_frontend_services~get_system_directory.
  ...
  METHOD zif_abappm_frontend_services~gui_is_available.
...
* when running on open-abap
  ...
  METHOD zif_abappm_frontend_services~is_sapgui_for_java.
...
* when running on open-abap
  ...
  METHOD zif_abappm_frontend_services~is_sapgui_for_windows.
...
* when running on open-abap
  ...
  METHOD zif_abappm_frontend_services~is_webgui.
...
* when running on open-abap
  ...
  METHOD zif_abappm_frontend_services~open_ie_devtools.

    DATA: lv_system_directory TYPE string,
          lv_exe_full_path    TYPE string.

    IF zif_abappm_frontend_services~is_sapgui_for_windows( ) = abap_false.
      zcx_abappm_error=>raise( |IE DevTools not supported on frontend OS| ).
    ENDIF.

    zif_abappm_frontend_services~get_system_directory( CHANGING cv_system_directory = lv_system_directory ).

    cl_gui_cfw=>flush( ).

    lv_exe_full_path = lv_system_directory && `\F12\IEChooser.exe`.

    zif_abappm_frontend_services~execute( iv_application = lv_exe_full_path ).

  ENDMETHOD.


  METHOD zif_abappm_frontend_services~show_file_open_dialog.
    ...
    IF lv_action = cl_gui_frontend_services=>action_cancel.
      zcx_abappm_error=>raise( 'Cancelled' ).
    ENDIF.
  ...
  METHOD zif_abappm_frontend_services~show_file_save_dialog.
