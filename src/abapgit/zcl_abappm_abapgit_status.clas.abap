CLASS zcl_abappm_abapgit_status DEFINITION
  PUBLIC
  FINAL
  CREATE PRIVATE.
...
************************************************************************
* This is a replacement for ZCL_ABAPGIT_REPO_STATUS
*
* Using ZCL_ABAPGIT_REPO_STATUS would drag in many other dependencies
...
CLASS zcl_abappm_abapgit_status IMPLEMENTATION.
  ...
  METHOD calculate.
    ...
    DATA lo_instance TYPE REF TO zcl_abappm_abapgit_status.
